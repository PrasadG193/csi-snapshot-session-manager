...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/PrasadG193/cbt-svc/pkg/apis/cbt/v1alpha1.VolumeSnapshotDeltaToken":       schema_pkg_apis_cbt_v1alpha1_VolumeSnapshotDeltaToken(ref),
		"github.com/PrasadG193/cbt-svc/pkg/apis/cbt/v1alpha1.VolumeSnapshotDeltaTokenList":   schema_pkg_apis_cbt_v1alpha1_VolumeSnapshotDeltaTokenList(ref),
		"github.com/PrasadG193/cbt-svc/pkg/apis/cbt/v1alpha1.VolumeSnapshotDeltaTokenSpec":   schema_pkg_apis_cbt_v1alpha1_VolumeSnapshotDeltaTokenSpec(ref),
		"github.com/PrasadG193/cbt-svc/pkg/apis/cbt/v1alpha1.VolumeSnapshotDeltaTokenStatus": schema_pkg_apis_cbt_v1alpha1_VolumeSnapshotDeltaTokenStatus(ref),
...
func schema_pkg_apis_cbt_v1alpha1_VolumeSnapshotDeltaToken(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VolumeSnapshotDeltaToken",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/PrasadG193/cbt-svc/pkg/apis/cbt/v1alpha1.VolumeSnapshotDeltaTokenSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/PrasadG193/cbt-svc/pkg/apis/cbt/v1alpha1.VolumeSnapshotDeltaTokenStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/PrasadG193/cbt-svc/pkg/apis/cbt/v1alpha1.VolumeSnapshotDeltaTokenSpec", "github.com/PrasadG193/cbt-svc/pkg/apis/cbt/v1alpha1.VolumeSnapshotDeltaTokenStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_cbt_v1alpha1_VolumeSnapshotDeltaTokenList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VolumeSnapshotDeltaTokenList",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/PrasadG193/cbt-svc/pkg/apis/cbt/v1alpha1.VolumeSnapshotDeltaToken"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/PrasadG193/cbt-svc/pkg/apis/cbt/v1alpha1.VolumeSnapshotDeltaToken", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_cbt_v1alpha1_VolumeSnapshotDeltaTokenSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VolumeSnapshotDeltaTokenSpec defines the desired state of VolumeSnapshotDeltaToken",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"baseVolumeSnapshotName": {
						SchemaProps: spec.SchemaProps{
							Description: "The name of the base CSI volume snapshot to use for comparison. If not specified, return all changed blocks.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"targetVolumeSnapshotName": {
						SchemaProps: spec.SchemaProps{
							Description: "The name of the target CSI volume snapshot to use for comparison. Required.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"mode": {
						SchemaProps: spec.SchemaProps{
							Description: "Defines the type of volume. Default to \"block\". Required.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
				},
				Required: []string{"targetVolumeSnapshotName"},
			},
		},
	}
}

func schema_pkg_apis_cbt_v1alpha1_VolumeSnapshotDeltaTokenStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VolumeSnapshotDeltaTokenStatus defines the observed state of VolumeSnapshotDeltaToken",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"error": {
						SchemaProps: spec.SchemaProps{
					...
					"token": {
						SchemaProps: spec.SchemaProps{
							Description: "Token cbt server token for validation",
							Type:        []string{"string"},
							Format:      "byte",
						},
					},
					"url": {
						SchemaProps: spec.SchemaProps{
							Description: "URL to get CBT metadata from",
							Type:        []string{"string"},
							Format:      "",
						},
					},
